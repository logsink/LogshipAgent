...
namespace Logship.Agent.Core.Inputs.Linux
{
    internal static class Interop
    {
        ...
        internal static extern int sd_journal_open(out IntPtr journal, int flags);
        ...
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_wait(IntPtr journal, int timeout_usec);
        ...
        /// <returns>Returns 0 if successful, or a negative error code if an error occurred.</returns>
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_close(IntPtr journal);
        ...
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_next(IntPtr journal);
        ...
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_get_data(IntPtr journal, string field, out IntPtr data, out UIntPtr length);
        ...
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_enumerate_available_data(IntPtr journal, out UIntPtr data, out UIntPtr length);
        ...
        /// <returns>Returns 0 if successful, or a negative error code if an error occurred.</returns>
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_seek_head(IntPtr journal);
        ...
        /// <returns>Returns 0 if successful, or a negative error code if an error occurred.</returns>
        [DllImport(LibSystemD)]
        internal static extern int sd_journal_seek_tail(IntPtr journal);
        ...
        {
            throw new Exception($"Linux interop error {errorCode}. {message}. {GetJournalErrorMessage(errorCode)}");
        }
